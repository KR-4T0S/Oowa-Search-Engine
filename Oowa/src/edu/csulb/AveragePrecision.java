...
import static edu.csulb.Oowa.RATE_MS_TO_SEC;

public class AveragePrecision {
    
    private static final int FIRST_QUERY_ITERATIONS = 30;
    ...
    public double getAveragePrecision() {
        ...
        for (Posting p: rankedResults) {
            ...
            //System.out.println("\t\t|\tCandidate: " + mCorpus.getDocument(p.getDocumentId()).getFileID() + ".json");
    ...
    public void getAveragePrecisionFirstQuery() {
        // Get results for current query & weight mode.
        //      this returns a maximum of 50 ranked postings
        double throughputSum = 0;
        for (int i = 0; i < 30; i++) {
            List<Posting> rankedResults = getResultsRanked();
            throughputSum += mResponseTime;
        }
        double MRT = (double) throughputSum / (double) (FIRST_QUERY_ITERATIONS);
        ...
        System.out.println("\t\tAverage Precision: " + AP_q);
        System.out.println("\t\tThroughput: " + throughput + " q/s");
    }
